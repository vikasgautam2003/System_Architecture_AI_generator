          ...
          <div className="lg:col-span-7">
            ...
            <div className="mt-10 flex gap-5">
              ...
              <button
                ...
                className="px-6 py-3.5 rounded-xl border border-slate-300 text-slate-700 hover:bg-slate-100 transition-all backdrop-blur active:scale-95"
              >
                Watch Demo
              </button>
            </div>
...
`}
      ...
      <VideoModal
        ...
        instructions={
          <div>
            <p>• Overview of how BlueprintX generates complete architectures.</p>
            <p>• Demonstration of Mermaid diagrams rendered dynamically.</p>
            <p>• Explanation and tech stacks displayed in futuristic UI.</p>
            <p>• Shows how full-screen and export functions work.</p>
          </div>
        }
      />
    </>
